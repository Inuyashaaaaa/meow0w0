...
export var AutoComplete = function (props) {
    ...
    var renderSuggestions = function () {
        return (React.createElement(Transition, { in: showDropdown || loading, animation: "zoom-in-top", timeout: 300, onExit: function () { setSuggestions([]); } },
            React.createElement("ul", { className: "meow-suggestion-list" },
                loading &&
                    React.createElement("div", { className: "meow-suggstions-loading-icon" },
                        React.createElement(Icon, { icon: "spinner", spin: true })),
                suggestions.map(function (suggestion, index) {
                    var cnames = classNames('meow-suggestion-item', {
    ...
    return (React.createElement("div", { className: "meow-auto-complete", ref: componentRef },
